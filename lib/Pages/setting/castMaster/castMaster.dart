...
import 'addCastpage.dart';

class Castmaster extends StatefulWidget {
  final String selectedLanguage;
  Castmaster({Key? key, required this.selectedLanguage}) : super(key: key);
  @override
  _CastmasterState createState() => _CastmasterState();
}

class _CastmasterState extends State<Castmaster> {
