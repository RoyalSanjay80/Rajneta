...
import 'addSocietypage.dart';

class Societymasterpage extends StatefulWidget {
  final String selectedLanguage;
  Societymasterpage({Key? key, required this.selectedLanguage}) : super(key: key);
  @override
  _SocietymasterpageState createState() => _SocietymasterpageState();
}

class _SocietymasterpageState extends State<Societymasterpage> {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton<String>(
          ...
          itemBuilder: (context) => [
            _buildMenuItem('Society Master', 'society_master'),
          ],
        ...
        onTap: (){
          ...
          if (user['master_permission']?['society_master'] == 1) {
            Get.to(() => AddSocietyPage(userid:user['id'],selectedLanguage:widget.selectedLanguage));
          } else {
            Get.snackbar(
              "Access Denied",
              "This user does not have Society Master permission",
              backgroundColor: Colors.red,
              colorText: Colors.white,
              snackPosition: SnackPosition.BOTTOM,
            );
