...
import '../karyakartaMaster/addkaryakarta.dart';
import '../societyMaster/addSocietypage.dart';
import 'addPositionMaster.dart';




class Positionmaster extends StatefulWidget {
  final String selectedLanguage;
  Positionmaster({Key? key, required this.selectedLanguage}) : super(key: key);
  @override
  _PositionmasterState createState() => _PositionmasterState();
}


class _PositionmasterState extends State<Positionmaster> {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton<String>(
          ...
          itemBuilder: (context) => [
            _buildMenuItem('Position Master', 'position_master'),
          ],
        ...
        onTap: (){
          ...
          if (user['master_permission']?['position_master'] == 1) {
            ...
            Get.snackbar(
              "Access Denied",
              "This user does not have position_master permission",
              backgroundColor: Colors.red,
              colorText: Colors.white,
              snackPosition: SnackPosition.BOTTOM,
            );
