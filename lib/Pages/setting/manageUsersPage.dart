...
class UserListScreen extends StatefulWidget {
  ...
  UserListScreen({Key? key, required this.selectedLanguage}) : super(key: key);
  @override
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton<String>(
          ...
          itemBuilder: (context) => [
            ...
            _buildMenuItem('Allow All Mobile Users To Create Master Data', 'all_permission'),
          ],
  ...
  void _assignPermission(int userId, String permissionKey) async {
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          "user_id": userId,
          permissionKey: 1, // Sending the selected permission with value 1
        }),
      );
