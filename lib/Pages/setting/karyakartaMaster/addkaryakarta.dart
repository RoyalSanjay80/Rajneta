          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  String societyName = _karyakartaController.text.trim();
                  if (societyName.isNotEmpty) {
                    _karyakarta.add(societyName); // Add to List
                    _karyakartaController.clear(); // Clear input
                    Get.back(); // Close bottom sheet
                    Get.snackbar(
                      "Added",
                      "Karyakarta '$societyName' added successfully!",
