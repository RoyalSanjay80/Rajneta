...
class Byextrainfo2 extends StatefulWidget {
  ...
  @override
  State<Byextrainfo2> createState() => _Byextrainfo2State();
}

class _Byextrainfo2State extends State<Byextrainfo2> {
  bool isLoading = true;
  bool hasError = false;
  String errorMessage = '';
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response = await http
          .get(
        Uri.parse(
          '${ApiConstants.baseUrl}api/voter-details-by-extra-information-two?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&extra_info_2=${widget.voterName}',
        ),
