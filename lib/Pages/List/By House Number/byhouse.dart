...
class Byhouse extends StatefulWidget {
  ...
  @override
  State<Byhouse> createState() => _ByhouseState();
}

class _ByhouseState extends State<Byhouse> {
  bool isLoading=true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      if (token == null) throw Exception('auth_token is not found');
      ...
      final response = await http.get(
        Uri.parse(
            '${ApiConstants.baseUrl}api/voter-details-by-houseno?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&house_no=${widget.voterName}'),
          ...
          children: [
            ...
            ? Center(child: Column(
              children: [
                ...
                ? Center(
              child: Text('No Result founds',style: TextStyle(
                fontSize: 16,
                color: Colors.white
              ),),
            )
