...
class Bydead extends StatefulWidget {
  ...
  @override
  State<Bydead> createState() => _BydeadState();
}

class _BydeadState extends State<Bydead> {
  bool isLoading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            '${ApiConstants.baseUrl}api/dead-live-voters-details?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&status=${widget.voterName.toLowerCase()}'),
