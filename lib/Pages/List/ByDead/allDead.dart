...
class AllDead extends StatefulWidget {
  final String itemName;
  final String selectedLanguage;

  AllDead({Key? key, required this.itemName, required this.selectedLanguage})
      : super(key: key);

  @override
  _AllDeadState createState() => _AllDeadState();
}

class _AllDeadState extends State<AllDead> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiConstants.baseUrl}api/dead-live-list'),
