...
import 'byExtraCheck2.dart';

class ExtraCheck2 extends StatefulWidget {
  ...
  @override
  _ExtraCheck2State createState() => _ExtraCheck2State();
}

class _ExtraCheck2State extends State<ExtraCheck2> {
  bool isLoading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final responce = await http.get(
        Uri.parse(
            '${ApiConstants.baseUrl}api/extra-check-two-voter-list'),
