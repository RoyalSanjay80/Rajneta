...
class ByPersonnel extends StatefulWidget {
  final String voterName;
  final String selectedLanguage;
  const ByPersonnel(
      {super.key, required this.voterName, required this.selectedLanguage});

  @override
  State<ByPersonnel> createState() => _ByPersonnelState();
}

class _ByPersonnelState extends State<ByPersonnel> {
  bool isLoading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            '${ApiConstants.baseUrl}api/personnel-voter-details?lang=${widget.selectedLanguage.substring(0,2).toLowerCase()}&status=${widget.voterName}'),
