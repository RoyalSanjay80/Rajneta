...
import 'byExtraCheck1.dart';

class AllExtraCheck1 extends StatefulWidget {
  ...
  @override
  _AllExtraCheck1State createState() => _AllExtraCheck1State();
}

class _AllExtraCheck1State extends State<AllExtraCheck1> {
  bool isLoading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final responce = await http.get(
        Uri.parse('${ApiConstants.baseUrl}api/extra-check-one-voter-list'),
            ...
            children: [
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      voter['name'] == 'ExtraChecked' ? 'Yes' : 'No',
                      style:
