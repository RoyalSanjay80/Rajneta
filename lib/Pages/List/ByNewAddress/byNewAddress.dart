...
class Bynewaddress extends StatefulWidget {
  ...
  @override
  State<Bynewaddress> createState() => _BynewaddressState();
}

class _BynewaddressState extends State<Bynewaddress> {
  bool isloading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiConstants.baseUrl}api/voter-details-by-new-address?lang=${widget.selectedLanguage.substring(0,2).toLowerCase()}&new_address=${widget.voterName}'),
      ...
      if (response.statusCode == 200) {
        ...
        if (data['voters'] is List) {
          setState(() {
            // Parse the voters data correctly
