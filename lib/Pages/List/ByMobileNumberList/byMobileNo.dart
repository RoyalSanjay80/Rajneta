...
class Bymobileno extends StatefulWidget {
  ...
  @override
  State<Bymobileno> createState() => _BymobilenoState();
}

class _BymobilenoState extends State<Bymobileno> {
  bool isLoding = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final responce = await http.get(
        Uri.parse(
            'https://rajneta.fusiontechlab.site/api/voter-details-by-mobile-no?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&mobile_1=${widget.voterName}'),
      ...
      if (responce.statusCode == 200) {
          ...
          setState(() {
            ...
            votersData = List<Map<String, String>>.from(
              ...
              return {
                  ...
                  ].where((namepasrt) => namepasrt.isNotEmpty).join(' '),
        ...
        throw Exception('fauld to load voter data');
      }
    } catch (e) {
      setState(() {
        isLoding = false;
