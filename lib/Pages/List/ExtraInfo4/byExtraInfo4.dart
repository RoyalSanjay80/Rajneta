...
import 'package:rajneta/Pages/LocalizationService.dart';
...
class Byextrainfo4 extends StatefulWidget {
  ...
  @override
  State<Byextrainfo4> createState() => _Byextrainfo4State();
}

class _Byextrainfo4State extends State<Byextrainfo4> {
  bool isloading = true;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final responce = await http.get(
          Uri.parse(
              '${ApiConstants.baseUrl}api/voter-details-by-extra-information-four?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&extra_info_4=${widget.voterName}'),
