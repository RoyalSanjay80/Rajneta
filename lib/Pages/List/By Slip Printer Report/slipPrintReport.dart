...
class SlipPrinterReport extends StatefulWidget {
  ...
  SlipPrinterReport({Key? key, required this.itemName, required this.selectedLanguage})
      : super(key: key);

  @override
  _SlipPrinterReportState createState() => _SlipPrinterReportState();
}

class _SlipPrinterReportState extends State<SlipPrinterReport> {
