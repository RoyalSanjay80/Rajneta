...
class BluetoothSlipReportByUser extends StatefulWidget {
  ...
  BluetoothSlipReportByUser({Key? key, required this.itemName, required this.selectedLanguage})
      : super(key: key);

  @override
  _BluetoothSlipReportByUserState createState() => _BluetoothSlipReportByUserState();
}

class _BluetoothSlipReportByUserState extends State<BluetoothSlipReportByUser> {
