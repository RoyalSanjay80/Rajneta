...
class Byextrainfo5 extends StatefulWidget {
  ...
  @override
  State<Byextrainfo5> createState() => _Byextrainfo5State();
}

class _Byextrainfo5State extends State<Byextrainfo5> {
  bool isLoading = true;
  ...
  Future<void> fetchdata() async {
    try {
      ...
      final responce = await http.get(
        Uri.parse(
            '${ApiConstants.baseUrl}api/voter-details-by-extra-information-five?lang=${widget.selectedLanguage.substring(0, 2).toLowerCase()}&extra_info_5=${widget.voterName}'),
